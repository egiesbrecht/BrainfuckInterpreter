...
If you want, you can wrap this whole thing into a .jar file and use it like *java -jar BrainfuckInterpreter.jar \*TheBrainfuckFileToExecute.bf*\*.
To use a file as an input is, as I already said, optional.
